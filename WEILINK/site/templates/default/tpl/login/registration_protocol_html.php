...
<div class="protocol">
	<div class="agreement" style="border:1px solid #292323;">
        <div class="agreement-header">
            <h1>威廉环球速递注册协议</h1>
        </div>
        <div class="agreement-main">
            <h3>尊敬的客户，欢迎您注册成为本网站客户。在注册前请仔细阅读如下服务条款：</h3>
            ...
            <h4>8、拒绝提供担保</h4>
            <p>用户明确同意信息服务的使用由用户个人承担风险。本网站不担保服务不会受中断，对服务的及时性，安全性，出错发生在能力范围内，避免出错。</p>
            <h4>9、有限责任</h4>
