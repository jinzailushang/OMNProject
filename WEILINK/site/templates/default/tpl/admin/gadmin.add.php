...
<div class="center">
    <div class="navTwo_cent">
        <ul class="navTwo_menu">
            ...
            <li><a href="javascript:void(0);" id="tabs_canApp" onclick="changeTabs(4, this)" class="choose">添加权限组 <font color="red"></font></a></li>
        </ul>
    </div>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" id="tab1">
                            ...
                            <tr class="noborder">
                                <td class="vatop rowform">所属权限组： <select name="gid" id="gid" style="float: none">
                                    ...
                                    <option value="<?php echo $v1['gid']?>"><?php echo $v1['gname']?></option>
                                    <?php endforeach;?>
                                </select></td>
                            ...
                            <?php endif;?>
                            <tr class="noborder">
                                <td class="vatop rowform">权限组名称： <input type="text" id="gname" maxlength="40" name="gname" class="txt" style="float:none !important;width:250px !important" ></td>
                                <td class="vatop tips"></td>
                            </tr>
                            <tr>
                                            ...
                                            <?php foreach ((array) $output['limit'] as $k => $v) { ?>
                                                <tr class="qxz">
                                                    <td>
                                                        ...
                                                        <label for="limit<?php echo $k; ?>" style="float:left;width:100px"><b><?php echo $v['name']; ?></b>&nbsp;&nbsp;</label>
                                                        <ul style="padding-left:40px">
                                                        <?php foreach ($v['child'] as $xk => $xv) { ?>
                                                            <!--如果是超级管理员，则列出所有权限-->
                                                            <?php if($output['gid'] == 1):?>
                                                            <li style="width:100%;height:15px;padding:5px 0">
                                                            <label style="float:left;width:100px"><input nctype='limit' class="limit<?php echo $k; ?>" type="checkbox" name="permission[]" value="<?php echo $xv['op']; ?>" style="width:20px !important" onclick="aa(this)">
                                                                <b><?php echo $xv['name']; ?></b>&nbsp;</label>
                                                                    <?php if($xv['sub']):?>
                                                                        <?php foreach($xv['sub'] as $sk=>$sv):?>
                                                                         <label style="float:left;width:100px"><input nctype="limit<?php echo $sk;?>" class="limit<?php echo $k;?>" type="checkbox" name="permission[]" value="<?php echo $sk;?>" style="width:20px !important"><?php echo $sv;?>&nbsp;</label>
                                                                        <?php endforeach;?>
                                                                    <?php endif;?>
                                                            </li>
                                                            <?php endif;?>
