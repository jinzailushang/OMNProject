<?php
     ...
     */
    class Config{
        static $appId="1464869664154114";//商户的应用ID
        // md5key LuUzBQUWgG0r4GuUcFC34gGKrEy363CX
        // key3des 7s5k6fcDXps8pa5zfXxcnYRw
        static $secure_key="LuUzBQUWgG0r4GuUcFC34gGKrEy363CX";//商户的秘钥
        static $timezone="Asia/Shanghai";//时间时区
        static $trade_time_out="3600";
        static $front_notify_url="http://o.welinkexpress.com/";
        static $back_notify_url="http://o.welinkexpress.com/";
