...
if (!@include(BASE_DATA_PATH . '/config/config.ini.php'))
...
define('SITE_SITE_URL', $config['site_site_url']);
...
$ignore = array('json', 'pgoods_body', 'doc_content', 'content', 'sn_content', 'g_body', 'store_description', 'p_content', 'groupbuy_intro', 'remind_content', 'note_content', 'ref_url', 'adv_pic_url', 'adv_word_url', 'adv_slide_url', 'appcode', 'mail_content');
...
require_once(BASE_CORE_PATH . '/framework/function/public.php');
