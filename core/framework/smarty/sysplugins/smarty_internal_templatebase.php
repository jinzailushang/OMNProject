...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     */
    public function fetch($template = null, $pic = 0, $cache_id = null, $compile_id = null, $parent = null, $display = false, $merge_tpl_vars = true, $no_output_filter = false)
    {
    ...
    private function pic($str) {
        // 加入图片地址优化
        $_arr = array();
        $_output_str = '';
        $_arr = explode('images.xianlife.com', $str);
        $a = '';
        foreach ($_arr as $key => $value) {
            if($key == 0) {
                ...
                $_output_str .= 'images' . ($key + 3) % 3 . '.xianlife.com';
                $_output_str .= $value;
            }
        }
     ...
     * @param object $parent     next higher level of Smarty variables
     */
    public function display($template = null, $pic = 0, $cache_id = null, $compile_id = null, $parent = null)
    {
        // display template
        $this->fetch($template, $pic, $cache_id, $compile_id, $parent, true);
    }
