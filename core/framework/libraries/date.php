 ...
 * @version   $Id: Date.class.php 2601 2012-01-15 04:59:14Z liu21st $
  +------------------------------------------------------------------------------
 */
class Date {
    ...
    public function firstDayOfMonth() {
        return (new Date(strftime("%Y-%m-%d", mktime(0, 0, 0, $this->month, 1, $this->year))));
    }
    ...
    public function firstDayOfYear() {
        return (new Date(strftime("%Y-%m-%d", mktime(0, 0, 0, 1, 1, $this->year))));
    }
    ...
    public function lastDayOfMonth() {
        return (new Date(strftime("%Y-%m-%d", mktime(0, 0, 0, $this->month + 1, 0, $this->year))));
    }
    ...
    public function lastDayOfYear() {
        return (new Date(strftime("%Y-%m-%d", mktime(0, 0, 0, 1, 0, $this->year + 1))));
    }
